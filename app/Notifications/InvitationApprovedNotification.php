...
class InvitationApprovedNotification extends Notification
{
  use Queueable;
  ...
  {
    return [
      'type' => NotificationTypeEnum::ACCEPTIVITATION->value,
      'message' => "'{$this->user->name}' Accepted To Join The '{$this->group->name}' Group",
