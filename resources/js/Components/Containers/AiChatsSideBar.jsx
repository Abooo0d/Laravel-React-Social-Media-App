    ...
    <div className="relative z-[101]">
      <div className=" max-h-barHeight h-full w-[270px] lg:flex hidden flex-col gap-2 py-2 bg-gray-900 px-2 border-r-solid border-r-gray-500/50 border-r-[1px]">
        <div className="flex w-full justify-between items-center h-fit py-1 px-4 ">
          ...
          {/* <BsStars className="w-[25px] h-[25px] text-gray-300" /> */}
        </div>
        <button className="bg-gray-900 flex justify-between items-center rounded-md text-gray-300 duration-200 hover:bg-gray-800 px-4 py-2">
          New Chat
          <FaPlus />
        </button>
        <div className="flex flex-row gap-2 flex-1 px-4 py-2">
          <h2 className="block text-xl font-bold dark:text-gray-300 cursor-default ">
            History:
          </h2>
          <AiChatsCardContainer
            show={showChats}
