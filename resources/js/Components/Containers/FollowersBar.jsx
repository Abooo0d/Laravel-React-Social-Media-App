...
const FollowersBar = ({ followers }) => {
  return (
    <div className="col-span-3 py-8 px-6 bg-gray-200 dark:bg-gray-900 max-h-100 min-h-100 overflow-hidden border-l-2 dark:border-gray-800 border-gray-300 border-solid">
