...
const MessagesContainer = ({ isLoading }) => {
  ...
  const abood = (abood4) => {};
  return (
    <div className="order-2 relative bg-gray-300 dark:bg-gray-900 dark:bg-chat-pattern bg-cover min-h-full md:max-h-barHeight flex-1 overflow-hidden flex flex-col justify-between items-center">
        ...
        <>
                ...
                {currentChat?.messages?.length >= 6 && (
                  <>
                    {thereIsMore ? (
                      ...
                      <div className="dark:bg-gray-900/50 bg-gray-300/50 backdrop-blur-sm w-fit mx-auto text-sm text-gray-500 rounded-md py-1 px-2 cursor-default border-solid border-gray-600/50 border-[1px] mb-4">
          ...
          {!currentChat && (
            <div className="w-full h-full flex justify-center items-center z-[50]">
              <div className="dark:bg-gray-900 bg-gray-300 dark:text-gray-500 text-gray-700 rounded-md px-8 py-4 cursor-default border-solid border-gray-600/50 border-[1px]">
