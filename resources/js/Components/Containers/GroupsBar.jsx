      ...
      <div className="relative z-[200]">
        ...
        >
          <div className="flex justify-between items-center dark:bg-gray-800 bg-gray-300 px-4 h-[48px]">
            <h2 className="dark:text-gray-400 text-gray-600 w-full py-3 lg:text-xl font-bold cursor-default max-h-full">
              Groups:
            </h2>
