...
const GroupsBar = ({ groups, setGroups }) => {
  ...
  return (
    <>
      <div className="block max-lg:hidden shadow-lg rounded-xl m-0 lg:rounded-none order-first col-span-3 lg:py-4 px-4 py-2 bg-gray-200 dark:bg-gray-900 lg:max-h-barHeight lg:min-h-barHeight max-h-[500px] h-full overflow-hidden lg:border-r-2 dark:border-gray-800 border-gray-300 border-solid lg:border-b-0">
        <div className="hidden lg:block">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-bold dark:text-gray-100">My Groups:</h2>
            <button
