...
const ChatInfoForm = () => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[800] w-screen overflow-y-auto flex min-h-full items-center justify-center dark:bg-gray-950/60 bg-gray-300/50 backdrop-blur-sm duration-200 ${
        showChatInfo ? `visible opacity-100` : `invisible opacity-0 scale-[95%]`
      }`}
    >
      <div className="flex justify-start items-center flex-col gap-4 animate-scaleUp h-fit max-h-[90%] w-[500px] max-w-[90%] rounded-lg relative dark:bg-gray-900/60 bg-gray-400/70 border-solid border-[1px] dark:border-gray-700 border-gray-500 backdrop-blur-md overflow-auto">
        <SecondaryButton
          event={close}
        ...
        <div className=" relative flex flex-col items-center justify-start pt-8 w-full z-0">
          ...
          <h2 className="w-fit dark:text-gray-300 text-gray-600 text-lg px-4 py-2 m-0 ">
            {currentChat?.name}
          </h2>
          {currentChat?.is_group ? (
        ...
        <div className="flex flex-col justify-start items-center w-full">
          <div className="flex justify-between items-center w-full text-gray-500 px-4 border-t-solid border-b-0 border-[1px] border-gray-500/50 border-x-0 py-4 dark:bg-gray-800/50 bg-gray-300">
            <h2>Created At:</h2>
          ...
          {currentChat?.is_group && (
            <div className="flex flex-col justify-start items-center w-full text-gray-500 px-4 border-t-solid border-b-0 border-[1px] border-gray-500/50 border-x-0 py-4 dark:bg-gray-800/50 bg-gray-300 cursor-pointer duration-200">
