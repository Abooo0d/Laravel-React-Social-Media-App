...
const PopupCard = ({ showForm, children, index = "" }) => {
  return (
    ...
    >
      <div
        className={`relative lg:max-w-[80%] max-w-[90%] w-[600px] rounded-xl max-h-[90%] overflow-auto bg-gray-900/90 border-[1px] border-solid border-gray-700 p-6 backdrop-blur-2xl duration-200 ${
