...
const SmallScreenGroupContainer = ({
  ...
  return (
    <div
      className={`absolute top-[150px] max-w-[80%] max-h-[60%] left-[75px] bg-gray-900/90 border-gray-700 border-solid border-[1px] backdrop-blur-md px-4 py-4 rounded-md shadow-2xl duration-200 overflow-hidden z-[100] ${
        showForm
    ...
    >
      <div className="flex justify-between items-center py-2">
        <h2 className="text-gray-400 font-bold">My Groups:</h2>
        <button
