...
const View = ({ auth, user }) => {
  ...
  const submitAvatarImage = () => {
    post(route("profile.changeImages"), {
      ...
      onSuccess: () => {
        setImageNotification("Image Updated Successfully");
        setTimeout(() => {
          setImageNotification("");
        }, 5000);
      },
  ...
  const submitCoverImage = () => {
    post(route("profile.changeImages"), {
      onStart: () => {
        errorsArray = [];
        setCoverNotification("");
      },
      onSuccess: () => {
        setCoverNotification("Image Updated Successfully");
        setTimeout(() => {
          setCoverNotification("");
        }, 5000);
      },
  ...
  return (
    <Authenticated user={auth.user}>
      <div className="container mx-auto ">
        <Notification success={imageNotification} errors={errorsArray} />
