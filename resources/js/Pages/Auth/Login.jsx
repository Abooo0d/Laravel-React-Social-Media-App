      ...
      <div className="w-full max-w-md flex flex-col justify-center items-center">
        ...
        <div className="w-full flex flex-col justify-center items-center mt-4 gap-2">
          <div className="w-full relative flex justify-center items-center">
            <span className="absolute w-[35%] h-[1px] bg-gray-700/80 left-9 top-[12px]" />
            <span className="text-gray-400">OR</span>
            <span className="absolute w-[35%] h-[1px] bg-gray-700/80 right-9 top-[12px]" />
          </div>
          <a href="/auth/google">
            <SecondaryButton classes="py-1.5 px-8 gap-2">
              Sign in with Google
